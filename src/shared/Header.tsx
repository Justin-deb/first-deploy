...
export default function Header() {
  const selected = ({isActive}:{isActive:boolean}) =>{
    return "text-black sm:text-2xl rounded-md px-2 py-1 hover:bg-neutral-300 " + (isActive? 'bg-neutral-200 border-2' : '')
  }
    ...
    <nav>
      <div className="flex items-center justify-between border-b-neutral-300 border-b-2">
        <div className="flex flex-1 items-center justify-between">
          <NavLink to='/' className="flex shrink-0 items-center pl-3 sm:text-2xl">
            <p>Movie Catalog</p>
          </NavLink>
          <div>
